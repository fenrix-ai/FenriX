 ...
 * yellow + a croissant emblem, while upcoming rounds render at low
 * opacity so players can see the full roadmap at a glance.
 *
      ...
      <div className="game-progress__track">
        {segments.map((seg) => {
          ...
          return (
            ...
            >
              <span
                className="game-progress__croissant"
                aria-hidden="true"
              >
                🥐
              </span>
